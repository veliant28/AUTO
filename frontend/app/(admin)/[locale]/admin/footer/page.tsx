...
export default function FooterPage() {
  ...
  const [localForms, setLocalForms] = React.useState<
    Record<string, FooterData>
  >({})
  ...
  const saveMutation = useMutation({
    mutationFn: async (locale: string) => {
      ...
      if (form.contact_phone)
        form.contact_phone = phoneToApi(form.contact_phone)
      if (form.support_phone)
        form.support_phone = phoneToApi(form.support_phone)
  ...
  useEffect(() => {
    ...
    return () => {
      delete (window as any).__saveFooter
    }
  }, [activeLocale])
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <PhoneInput
                    value={apiToPhone(form.contact_phone)}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_delivery_pickup')}
                  </label>
                  {ta('delivery_pickup')}
                </div>
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_delivery_timing')}
                  </label>
                  {ta('delivery_timing')}
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_support_chat')}
                  </label>
                  {inp('support_chat')}
                </div>
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_support_email')}
                  </label>
                  {inp('support_email', 'email')}
                </div>
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_support_phone')}
                  </label>
                  <PhoneInput
                    value={apiToPhone(form.support_phone)}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_terms_copyright')}
                  </label>
                  {ta('terms_copyright')}
                </div>
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_terms_personal')}
                  </label>
                  {ta('terms_personal')}
                </div>
                <div>
                  <label className="text-sm text-muted-foreground mb-1 block">
                    {t('footer_terms_liability')}
                  </label>
                  {ta('terms_liability')}
                </div>
              </CardContent>
