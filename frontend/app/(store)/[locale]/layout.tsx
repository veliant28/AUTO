...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  const meta: Record<string, any> = {
    ru: {
      ...
      desc: 'Более 235 000 запчастей. Мгновенный поиск по каталогу TecDoc. Оригинальные детали и качественные аналоги.',
    },
    en: {
      title: `${brandName} — online auto parts store`,
      desc: 'Over 235,000 parts. Instant search via TecDoc catalog. Original parts and quality alternatives.',
    },
    ua: {
      title: `${brandName} — інтернет-магазин автозапчастин`,
      desc: 'Понад 235 000 запчастин. Миттєвий пошук за каталогом TecDoc. Оригінальні деталі та якісні аналоги.',
    },
  }
...
export default async function RootLayout(props: any) {
  ...
  try {
    const res = await fetch(`${API}/categories/header?locale=${locale}`, {
      cache: 'no-store',
