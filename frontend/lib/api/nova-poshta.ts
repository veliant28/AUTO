...
export const novaPoshtaApi = {
  ...
  updateSender: (id: number, data: NovaPoshtaSenderProfileUpdate) =>
    apiClient.put<NovaPoshtaSenderProfile>(
      `/admin/nova-poshta/senders/${id}`,
      data,
    ),
  ...
  searchSettlements: (data: NovaPoshtaLookupQuery) =>
    apiClient.post<NovaPoshtaLookupSettlement[]>(
      '/admin/nova-poshta/lookup/settlements',
      data,
    ),

  searchStreets: (data: NovaPoshtaStreetLookupQuery) =>
    apiClient.post<NovaPoshtaLookupStreet[]>(
      '/admin/nova-poshta/lookup/streets',
      data,
    ),

  searchWarehouses: (data: NovaPoshtaWarehouseLookupQuery) =>
    apiClient.post<NovaPoshtaLookupWarehouse[]>(
      '/admin/nova-poshta/lookup/warehouses',
      data,
    ),

  listPackTypes: (data: NovaPoshtaPackListLookupQuery) =>
    apiClient.post<NovaPoshtaLookupPackaging[]>(
      '/admin/nova-poshta/lookup/pack-types',
      data,
    ),

  getServices: (data: NovaPoshtaServiceLookupQuery) =>
    apiClient.post<NovaPoshtaServiceItem[]>(
      '/admin/nova-poshta/lookup/services',
      data,
    ),

  getTimeIntervals: (data: NovaPoshtaTimeIntervalsLookupQuery) =>
    apiClient.post<NovaPoshtaLookupTimeInterval[]>(
      '/admin/nova-poshta/lookup/time-intervals',
      data,
    ),

  getDeliveryDate: (data: NovaPoshtaDeliveryDateLookupQuery) =>
    apiClient.post<NovaPoshtaLookupDeliveryDate[]>(
      '/admin/nova-poshta/lookup/delivery-date',
      data,
    ),

  searchCounterparties: (data: NovaPoshtaCounterpartyLookupQuery) =>
    apiClient.post<NovaPoshtaLookupCounterparty[]>(
      '/admin/nova-poshta/lookup/counterparties',
      data,
    ),

  getCounterpartyDetails: (data: NovaPoshtaCounterpartyDetailsQuery) =>
    apiClient.post<NovaPoshtaCounterpartyDetails | null>(
      '/admin/nova-poshta/lookup/counterparty-details',
      data,
    ),
  ...
  getWaybillEvents: (waybillId: number) =>
    apiClient.get<WaybillEventResponse[]>(
      `/admin/nova-poshta/waybills/${waybillId}/events`,
    ),
