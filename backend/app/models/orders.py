...
class Order(Base):
    ...
    delivery_city_ref = Column(String, nullable=True)
    delivery_settlement_ref = Column(String, nullable=True)
    delivery_city_label = Column(String, nullable=True)
    delivery_warehouse_ref = Column(String, nullable=True)
    delivery_warehouse_label = Column(String, nullable=True)
    delivery_street_ref = Column(String, nullable=True)
    delivery_street_label = Column(String, nullable=True)
    delivery_house = Column(String, nullable=True)
    delivery_apartment = Column(String, nullable=True)
    payment_method = Column(String, nullable=True)
    promocode_id = Column(Integer, ForeignKey("promocodes.id"), nullable=True)
    promocode_code = Column(String(10), nullable=True)
