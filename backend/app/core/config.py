...
class Settings(BaseSettings):
    ...
    RATE_LIMIT_PER_MINUTE: int = Field(default=300, ge=1, le=10000)
    RATE_LIMIT_PER_HOUR: int = Field(default=6000, ge=1, le=100000)
    RATE_LIMIT_PER_ENDPOINT: int = Field(default=150, ge=1, le=5000)
