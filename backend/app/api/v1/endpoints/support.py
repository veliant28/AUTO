...
def get_chat_messages(
    ...
    for m in messages:
        result.append(ChatMessageOut(
            ...
            sender_name=f"{m.sender.first_name or ''} {m.sender.last_name or ''}".strip() or m.sender.full_name or m.sender.email,
            sender_group=m.sender.role.name if m.sender.role else None,
