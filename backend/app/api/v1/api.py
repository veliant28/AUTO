...
from app.api.v1.endpoints import catalog, users, cart, auth, favorites, orders, notifications, telegram, footer, settings, categories, returns, nova_poshta, loyalty
